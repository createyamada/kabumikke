...
EXPLANATORY_VARIABLES_ANALYSIS = [
    ...
    'volatility5',
    'volatility60',
    'downside_volatility20',
    'return_skew20',
    'atr14_change5',
    'volume_change',
    'volume_ratio20',
    'volume_ratio60',
    'amihud_illiquidity20',
    'sma5_sma25_gap',
    'sma25_sma70_gap',
    'sma5_slope5',
    'sma25_slope5',
    ...
    'bearish_engulfing',
    'doji',
    'upside_gap_side_by_side_white',
    'island_bottom',
    'double_bottom_setup',
    'double_bottom_breakout',
    'pampaka_pan_bull',
    'pampaka_pan_strength',
    'elliott_impulse_score',
    'elliott_wave_position',
    'fibonacci_retracement_position60',
    'stochastic_k',
    'stochastic_d',
    'plus_di14',
    'minus_di14',
